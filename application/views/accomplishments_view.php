                                ...
                                <div class="col-md-12">
                                    <div id="div_chart_list">
                                        ...
                                        <div style="border-top:5px solid rgb(76, 175, 80);">
                                                <h1 style="padding-left: 20px;"><span class="fa fa-check" style="border: 3px solid rgb(76, 175, 80); padding: 10px 12px 10px 12px; border-radius: 50%; color: rgb(76, 175, 80);"></span> Accomplishments <small>| Processing </small></h1><hr>
                                        </div>
                                            <div class="row">
