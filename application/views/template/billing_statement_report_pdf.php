		...
		<td width="100%">
			<div style="border: 1px solid black;">
				<table width="100%" cellspacing="0">
					<td style="width: 35%;">
						<div class="text-center">
							...
							<span style=""><strong>M. NG &amp; T. LOPEZ PARTNERSHIP FIRM</strong></span><br>
				...
				<table width="100%" style="" cellspacing="0">
					...
					<tr>
						<td width="70%" style="border-right: 1px solid black; padding: 0 0 0 40px;"><?php echo $current_charge->charge_name; ?></td>
						<td width="30%" align="right" style=" padding-right: 10px;"><?php 
				...
				<table width="100%" cellspacing="0">
					<tr>
						<td width="40%" style="border-top: 1px solid black;"><span style=""><strong>Received By:</strong></span></td>
						<td width="30%" style="border-top: 1px solid black;"><span style=""><strong>TOTAL</strong></span></td>
						<td width="30%" style="border-top: 1px solid black; text-align: right; padding-right: 10px; "><?php
						$total = $sum_beginning + $sum_curr_charge; 
						echo number_format($total,2); ?></td>
					</tr>
					<tr>
						<td width="40%"></td>
						<td width="30%"><span style="">Less: Cash Advance</span></td>
						<td width="30%" style="text-align: right; padding-right: 10px;">-</td>
					</tr>
					<tr>
						<td width="40%"></td>
						<td width="30%"><span style="">Less: Advance Payment</span></td>
						<td width="30%" style="text-align: right; padding-right: 10px;"><?php echo ($billing_info->advance_payment == 0 ? '-' : number_format($billing_info->advance_payment,2)); ?></td>
					</tr>
					<tr>
						<td width="40%" style="border-top: 1px solid black; "><center>Signature over printed name</center></td>
						<td width="30%" style="border-top: 1px solid black; border-bottom: 3px double black;"><span style=""><strong>Total Amount Due</strong></span></td>
						<td width="30%" style="border-top: 1px solid black;text-align: right; padding-right: 10px; border-bottom: 3px double black;"><strong><?php 
							$total_amount_due = 0;
					...
					<tr>
						<td colspan="3"><small style=""><center>
