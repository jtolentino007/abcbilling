<?php foreach($previous_fees as $fee){ ?>
    ...
    <tr>
        ...
        <td align="right"><input name="beginning_balance_remaining[]" class="form-control numeric" value="<?php echo number_format($fee->beginning_amount,2); ?>" style="text-align: right;" /></td>
