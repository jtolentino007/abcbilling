        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content"><!---content-->
                ...
                <div class="col-sm-12">
                    ...
                    <p id="modal-body-message">Are you sure you want to cancel this payment? <br>
                    This process is irreversible.</p>
                    <i>Deleted by : <?php echo $this->session->user_fullname; ?></i><br>
                    Cancellation Remarks <b style="color:red!important;">*</b>
                    <textarea name="cancel_remarks" id="cancel_remarks" class="form-control"> </textarea>   
                </div>
...
<script>
    $(document).ready(function(){
        ...
        var cancelPayment=function(){
            var _data = Array();
            _data.push({name:"cancel_remarks",value:($('#cancel_remarks').val())});
            _data.push({name:"payment_id",value: _selectedID});
            return $.ajax({
                "dataType":"json",
                "type":"POST",
