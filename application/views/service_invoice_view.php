                                                            ...
                                                            <div class="tab-content">
                                                                <div class="tab-pane active" id="billing_statement" style="min-height: 250px;">
                                                                    <div style="padding: 0.5%;">
                                                                        <span style="font-size: 14pt;">Billing as of <b class="lbl_date"><?php echo date('F'); ?> <?php echo date('Y'); ?></b></span><hr />
                                                                ...
                                                                <div class="tab-pane " id="customer_list" style="min-height: 250px;">
                                                                    <div style="padding: 1%;">
                                                                        <span style="font-size: 14pt;">Account / Contract Billing Status as of <b class="lbl_date"><?php echo date('F'); ?> <?php echo date('Y'); ?></b></span><hr />
            ...
            $('#tbl_customers tbody').on( 'click', 'tr td.details-control', function () {
                ...
                if ( row.child.isShown() ) {
                    ...
                    $.ajax({
                        "dataType":"html",
                        "type":"POST",
                        "url":"Accomplishments/transaction/expand-view?id="+ d.customer_id+"&contract_id="+d.contract_id,
                        "beforeSend" : function(){
