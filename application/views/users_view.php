                                            ...
                                            <div class="panel-body">
                                               ...
                                               <form id="frm_users" role="form" class="form-horizontal row-border">
                                                   ...
                                                   <div class="form-group">
                                                       ...
                                                       <div class="col-md-5">
                                                           <div class="input-group">
                                                               <div class="" style="border:1px solid black;height: 230px;width: 210px;vertical-align: middle; width: 50%; height: 50%; border-radius: 50%;">

                                                                   <div id="div_img_user" style="position:relative; width: 100%; height: 100%; border-radius: 50%;">
                                                                       <img name="img_user" src="assets/img/default-user-image.png" style="object-fit: fill; !important; height: 100%;width: 100%; border-radius: 50%;" />
...
<script>
    $(document).ready(function(){
            ...
            dt=$('#tbl_user_list').DataTable({
                ...
                "columns": [
                    ...
                    { targets:[5],data: "user_group" },
                    {
                        ...
                        var btn_edit='<button class="btn btn-primary btn-sm <?php echo (in_array('3-3-e',$this->session->user_rights)?'':'hidden'); ?>" name="edit_info"  style="margin-left:-15px;" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil"></i> </button>';
                        var btn_trash='<button class="btn btn-danger btn-sm <?php echo (in_array('3-3-d',$this->session->user_rights)?'':'hidden'); ?>" name="remove_info" style="margin-right:0px;" data-toggle="tooltip" data-placement="top" title="Move to trash"><i class="fa fa-trash-o"></i> </button>';
        ...
        var bindEventHandlers=(function(){
            ...
            $('#tbl_user_list tbody').on( 'click', 'tr td.details-control', function () {
                ...
                if ( row.child.isShown() ) {
                    ...
                    $.ajax({
                        "dataType":"html",
                        "url":"Templates/layout/clients-assignment/"+d.user_id
                    }).done(function(response){
                        row.child(response).show();
                        reInitializeDatatable($('#tbl_customers_'+d.user_id));
                        reInitializeChildEntriesTable($('#tbl_customers_'+d.user_id), d.user_id);
                        //Add to 'open' array
                        if ( idx === -1 ) 
        ...
        var reInitializeChildEntriesTable=function(tbl,user_id){
            tbl.on('click','button[name="btn_assign"]',function(){
                var _data = [];

                _data.push({name : "user_id" , value : user_id });
                _data.push({name : "customer_id" ,value : $(this).val() });
                ...
                if($(this).hasClass('btn-success')) {
                  ...
                  $.ajax({
                      "dataType":"json",
                      "type":"POST",
                      "url":"User_customers/transaction/unassign",
                      "data": _data
                  }).done(function(response){
                      showNotification(response);
                  });
                  ...
                  $.ajax({
                      "dataType":"json",
                      "type":"POST",
                      "url":"User_customers/transaction/assign",
                      "data": _data
                  }).done(function(response){
                      showNotification(response);
                  });
