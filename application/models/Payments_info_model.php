<?php
	class Payments_info_model extends CORE_Model
	{
		...
		$sql="SELECT
			...
			paid.*,
			ci.*,
			IFNULL(IFNULL(billed.billed_amount,0) - IFNULL(paid.total_collected,0) - IFNULL(paid.advance_amount,0),'-') 
			outstanding_balance
...
function get_client_summary_report_updated($month,$year){
